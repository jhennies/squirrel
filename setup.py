...
setup(
    ...
    entry_points={  # Naming scheme: sq-<namespace>-<func-name>
        'console_scripts': [
            ...
            'sq-serialem-parse-navigator-file = squirrel.serial_em:parse_navigator_file',
            ...
            'sq-stack-tif-nearest-scaling = squirrel.stack_operations:tif_nearest_scaling',
            'sq-stack-invert-slices = squirrel.stack_operations:invert_slices',
